import { Announcement, LiveHelp, NewReleases, Reddit, Storefront, Twitter, YouTube } from '@mui/icons-material';
...
export const Footer: React.FC = () => {
  return (
    <Box sx={{ textAlign: 'center', flexShrink: 0, mt: 8, pb: 4 }}>
      <Container maxWidth="md">
        ...
        <Typography variant="caption">
          ...
          <Button href="/help" color="inherit" target="_blank" rel="noopener" startIcon={<LiveHelp />}>
            Help Center
          </Button>
          <Button
        ...
        <Box sx={{ pb: 1 }}>
          <IconButton component="a" href="/twitter" target="_blank" rel="noopener">
            <Twitter />
          </IconButton>
          <IconButton component="a" href="/youtube" target="_blank" rel="noopener">
            <YouTube />
          </IconButton>
          <IconButton component="a" href="/reddit" target="_blank" rel="noopener">
            <Reddit />
          </IconButton>
          <IconButton component="a" href="/discord" target="_blank" rel="noopener">
            <SvgIcon component={DiscordIcon} inheritViewBox />
          </IconButton>
          <IconButton component="a" href="/patreon" target="_blank" rel="noopener">
